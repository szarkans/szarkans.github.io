...
![Пример разноцветного ника](/assets/guides/nick/rgb_nick.webp){ width=75% .small-img-border loading="lazy" decoding="async"}
...
2. В поле `Message` вводишь свой ник или что хочешь
    ...
    ![Поле ввода ника](/assets/guides/nick/message.webp){.small-img-border loading="lazy" decoding="async"}

3. Слева выбираешь стиль ника - количество цветов, сами цвета, жирный, подчёркнутый и т.п. **Обязательно выбери тип Legacy сверху!**

    ![Выбор цветов](/assets/guides/nick/sett.webp){ width=50% .small-img-border loading="lazy" decoding="async"}
