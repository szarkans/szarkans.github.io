...
[ :material-arrow-top-right: Изменение механик ванильных предметов ](/bestiary/vanilla/vanilla_edits.md){ .md-button .md-button--primary }
...
На сервер добавлены новые картины за авторством [**bykkake747**](/info/admins.md) и разных котиков!
