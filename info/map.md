...
<Image src="/assets/info/map/main.webp" alt="" width="80%" preview />

==Спавн
Собственно, спавн. Здесь всё и начинается.

<Image src="/assets/info/map/spawn_spawn.webp" alt="" width="80%" preview />

==Бар "Баюн"
Здесь можно взять квесты у Бармена и хорошо провести время.

<Image src="/assets/info/map/spawn_bar.webp" alt="" width="80%" preview />

==Банк
Здесь можно пополнить/снять АРы.

<Image src="/assets/info/map/spawn_bank.webp" alt="" width="80%" preview />

==Поле пшеницы
Благодаря священной земле, пшеница растёт сама по себе...

<Image src="/assets/info/map/spawn_farm.webp" alt="" width="80%" preview />

==Администрация
Здесь можно зарегистрировать клан или узнать о нём информацию у Администратора.

<Image src="/assets/info/map/spawn_admin.webp" alt="" width="80%" preview />

==Церковь
Здесь можно получить благословение у Священницы.

<Image src="/assets/info/map/spawn_church.webp" alt="" width="80%" preview />
...
<Image src="/assets/info/map/spawn_teatr.webp" alt="" width="80%" preview />
...
<Image src="/assets/info/map/spawn_music.webp" alt="" width="80%" preview />

==Аркадий Гусев
Здесь стоит Аркаша - у него можно за АРы купить облики на предметы, а также посмотреть донатные облики!

<Image src="/assets/info/map/spawn_valera.webp" alt="" width="80%" preview />
:::
