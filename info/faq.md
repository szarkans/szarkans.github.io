...
Для этого нужно зайти в [наш Дискорд](https://discord.gg/anVPzeKb) и подать заявку в канале `#заявка`!
...
На момент **7** сезона - **1.21.4 Java**. Игра на Bedrock или PE издании, на данный момент, невозможна и не планируется.
...
Обычный мир - **5000 х 5000**, в последствии будет расширен

Ад - **2500 х 2500**, в последствии будет расширен
