...
Модифицированное ядро **Paper**! Поэтому нет, вы не сможете построить *те самые* постройки с одного популярного сервера стримеров.
...
![Пример фермы на кошкокрафте](/assets/info/farm/farm_example.webp) -->

## Симуляция и прорисовка

На Кошкокрафте стоит **6 чанков симуляции** и **12 чанков прорисовки**. При лагах или задержках, симуляция понижается до **4 чанков**, а прорисовка до **10 чанков**.