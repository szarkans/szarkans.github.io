...
`1.1.` Максимально возможный штраф от правительства - 1024 АР (16 стаков)
...
- Кроме вещей внешнего мира, их вопросами занимаются Всекоты.
...
Данный раздел расписан исключительно для правительства как их регулятор работы. Он никак не связан с обычными гражданами! 
...
- **Президент** имеет дополнительные полномочия, включая возможность создавать чрезвычайные указания в случае экстренной ситуации.
<span class="gray">*Это решение принимается путём голосования министров и парламента и не может быть оспоренным даже божьим судом*</span>
...
`2.3.` Совет Министров и парламент:

- В совет Министров входит: культура, экономика, ГКСБ, строительство.

- **Парламент** прикреплён к конкретной роли в рядах **Министров** 

- Все министры назначаются путём выбора **Президента**.

    - Исключение: В случае, если нет кандидатуры, то президент вправе объявить выборы министра на нужную должность.
...
- Один срок в Кошачьем конгрессе составляет 3 месяца.
...
- Совет министров сменяется **полностью**.

`2.7.` Смещение с должности:
- **Президента** можно снять при помощи народного голосования при наличии петиции (81% от среднего онлайна). Каждая петиция должна быть проверена министрами, а также им должен быть передан оригинал петиций.
...
- Граждане Кошкокрафта имеют право создать голосование об **исключении** определённого члена Кошачего конгресса. Для этого нужно любыми способами собрать **81%** голосов от среднего количество активно-проживающих котиков в Стране.  
<span class="gray">*Условно, средний онлайн - 50 человек. Для гарантированного исключения члена Кошачего конгресса нужно собрать 41 уникальных подписей/голосов/прочьего.*</span>

`2.8.` Привилегии Президента:

- **Президент** имеет право принимать решения в чрезвычайных ситуациях, не вводя положения ЧС, что помогает поддерживать порядок на сервере.

- **Президент** имеет право вето на все решения Кошачьего конгресса.

- **Президент** имеет право выносить наказания за деяния, не предусмотренные в законе, в случаях, когда нарушение очевидно и представляет угрозу безопасности котят или нарушает их личные права. Такое наказание может быть установлено если нет иного выбора или в случае, если нарушение нарушает основные принципы справедливости или устои страны, а также с учетом мнения большинства участников Совета министров.

- **Президент** имеет полное право объявлять котёнка в розыск. Эта процедура может быть инициирована напрямую путём голосования правительства и без оформления репорта, если речь идёт о лицах, представляющих угрозу безопасности страны, или тех, кто совершил тяжкие преступления против государства.

`2.9.` Условия вступления на пост:

- Котик может быть принят на гост-пост в Кошачий конгресс только при условии, что он пробыл на кошачьих землях не менее **150 часов**.

:::

::: details 3. Устав КСБ

Данный раздел расписан исключительно для регуляторов работы КСБ. Он никак не связан с обычными гражданами!
Но у граждан есть право подчиниться законным требованиям КСБ или быть наказанными в случае помехи.
...
`4.7.` Каждая петиция рассматривается членами Кошачего конгресса, и проверяется её целесообразность. После одобрения она вступает в силу.
...
- За каждую повёрнутую рамку (или арт) - 3 АР
...
- Любая незеритовая броня — 50 АР

- Любой незеритовый инструмент — 43 АР
...
- Шаблон «Кузнечное улучшение» - 20 АР.

- Декоративные шаблоны - 9 АР


### Предметы из Внешнего Мира

Предметами из внешнего мира считаются теми, которые были куплены с сайта <https://donate.catcraftmc.ru>
КСБ не разбирает репорты с этими вещами, этим занимаются Всекоты.

- Формула стоимости предмета: `1₽ = 2АР`, если предмет в наборе один (прим. - Котомат, он будет стоить `298 АР`)
- Если в наборе продаётся более одного предмета (прим. - наборы Обликов, Киты), то формула будет `(кол-во ₽ * 2) / кол-во предметов в наборе`. Так, условный УПМ будет стоить `149 АР`, т.к. их две штуки в наборе (`149₽ * 2 = 298 / 2 = 149 АР`)
