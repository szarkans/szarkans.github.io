...
`1.12.` Подкуп/взятничество <u>любых</u> голосов/подписей/прочего в <u>любых</u> опросах/выборах/прочем карается **1 днём тюрьмы** и **100 АР** штрафа за каждый случай.
:::
...
`3.7.` Офицер, получивший <u>3 выговора</u>, снимается с должности без возможности восстановиться до конца света.
...
`3.11.` Офицер - <u>лицо правосудия</u>, и должен соблюдать субординацию и вести себя подобающе с гражданами нашей страны, независимо от его отношения к ним.
...
- <u>При согласии вернуть ресурсы</u>: возврат ресурсов пострадавшему + моральная компенсация пострадавшему в размере 50% от стоимости ресурсов. 
...
- Столицей является весь остров + 50 блоков от ближайшей суши столицы
...
- `11.1.1` Пометкой территории можно считать то, визуально обозначено по всему периметру территории котика - забор, столбы, яркие ковры, таблички (если идут в ряд), факела (если идут в ряд)
