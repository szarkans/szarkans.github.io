...
`6.6.` При отсутствии доказательств нападения, КСБ обязано **закрыть дело**, ссылаясь на закон `1.0`

`6.7.` Если котёнок был вынужден использовать **ресурсы** в процессе самообороны, то **нападающая сторона обязана их компенсировать** —  в **физическом виде** или в **АР по минимальной цене**.
