...
**Важно!** При покупке тебе выдаются **шаблоны** обликов - эти шаблоны ты можешь наложить на свои существующие предметы.
...
- Набор <span class="neon">**Божественное откровение**</span>

    ---

    ![god_bless](../assets/donates/skins/god_bless.jpg)
