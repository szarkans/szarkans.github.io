...
На Кошкокрафте стоит система **ребаланса жителей**, а именно **Библиотекарей**, **Бронников** и **Картографов**. Теперь некоторые трейды чуть дороже, а получить нужные зачарования стало сложнее.
