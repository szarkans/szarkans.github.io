...
??? note-cc "1. Основа"
    ...
    `1.7.` Если в течение 30 суток Внешнего мира, после совершения преступления, пострадавший не сообщил о нём в КСБ, то нарушение не будет считаться действительным, а последующие репорты будут отклонены.
    
    :   Исключением являются те случаи, когда пострадавший не мог узнать о преступлении, за счёт долгого отсутствия на землях Кошкокрафта или других причин.

    `1.8.` Поиск и использование дыр или лазеек в законе запрещается и использование их в качестве доказательств/аргументов будет проигнорировано.

    `1.9.` Рецидив - это повторение того же нарушения в течение недели после закрытия репорта или выхода из тюрьмы.
    ...
    `1.10.` В измерении Энда (*Края*) законы не отслеживаются КСБ, за исключением закона о гриферстве.  
    Это означает, что в Энде (*Крае*) можно убивать, воровать, но не гриферить.

    `1.11.` Нарушение по отношению к новоприбывшему (менее 15 часов в нашей стране) будет рассматриваться **Всекотами**.

    `1.12.` Соучастие или содействие в ^^любом^^ нарушении влечёт то же наказание, что и нарушителю, но в два раза меньше.  
    ...
    `1.13.` Подкуп/взятничество ^^любых^^ голосов/подписей/прочего в ^^любых^^ опросах/выборах/прочем карается **1 днём тюрьмы** и **100 АР** штрафа за каждый случай.
...
??? note-cc "1.6. Система залогов"    
    ...
    `1.6.1.` Любой котёнок, за исключением самого нарушителя, может внести залог за котёнка. который находится в тюрьме. Для внесения залога, необходимо:
        ...
        - Написать репорт КСБ и изъявить желание внести залог. В репорте необходимо сообщить:
...
??? note-cc "6. Правительство, Парламент"
