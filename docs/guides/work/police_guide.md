...
Отклонить репорт можно командой `/отклонитьрепорт`. Отклонять репорты можно если истец не указал важные данные, сам забил на репорт или по прочим **объективным** причинам.
