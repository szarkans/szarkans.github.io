...
Версии: 1.20.1 - 1.20.4  
Даты: 01.07.2023 - 07.04.2024
:::
...
- Была создана новая Вики (сейчас ты читаешь **ещё более** новую :D)
    ...
    <Image src="/assets/server_history/season5/oldold_wiki.webp" preview />
...
![Аукцион контейнеров](/assets/server_history/season5/auction.webp){ decoding="async" loading="lazy" }
...
- Добавлена поддержа [кастомных моделей персонажа](/gameplay/unique/mods/cpm.md) и добавлено редактирование армор-стендов.
...
![assds](/assets/server_history/season5/выборы.webp){ }
...
![Приглашение на свадьбу](/assets/server_history/season5/wedd_invite.webp){ decoding="async" loading="lazy" }
...
![Свадьба](/assets/server_history/season5/wedd.webp){ decoding="async" loading="lazy" }
...
![rozysk](/assets/server_history/season5/poster_wanted.webp){ decoding="async" loading="lazy" }
...
![Томми на фоне банка](/assets/server_history/season5/tommy_president.webp){ decoding="async" loading="lazy" }

## 31 декабря - 1 января - Новый год!

Новый год! Была опубликована статистика сервера.

![statistic](/assets/server_history/season5/stats1.webp){ decoding="async" loading="lazy" }

![stats2](/assets/server_history/season5/stats2.webp){ decoding="async" loading="lazy" }
...
![Рофлс от админов](/assets/server_history/season5/rofl.webp){ decoding="async" loading="lazy" }
...
![Билд-баттл](/assets/server_history/season5/buildbattle.webp){ decoding="async" loading="lazy" }
...
![Представитель, выборы президента](/assets/server_history/season5/choose.webp){ decoding="async" loading="lazy" }
...
![Гладиаторы на арене](/assets/server_history/season5/gladiators.webp){ decoding="async" loading="lazy" }
...
![Арт-музей](/assets/server_history/season5/artmusei.webp){ decoding="async" loading="lazy" }
...
![РП-зона](/assets/server_history/season5/rpzone.webp){ decoding="async" loading="lazy" }
...
![mistake](/assets/server_history/season5/bitch_in_jail.webp){ decoding="async" loading="lazy" }
...
![ult](/assets/server_history/season5/ultimatum.webp){ decoding="async" loading="lazy" }
...
![Она вам не Домикс!](/assets/server_history/season5/domix.webp){ decoding="async" loading="lazy" }
...
![Зона без трусов](/assets/server_history/season5/nopanties.webp){ decoding="async" loading="lazy" }
...
![Аукцион Скорохода](/assets/server_history/season5/auc_skoroc.webp){ decoding="async" loading="lazy" }

В этот же день некоторые Символы Власти обрели своих новых хозяев - **sm1lly** получил Символ Пути, а **Skorohodon** - Символ Цепи.

![Рендер пустых-владельцов символов](/assets/server_history/season5/empty_render.webp){ decoding="async" loading="lazy" }
...
![Построенный театр](/assets/server_history/season5/teatr.webp){ decoding="async" loading="lazy" }

![Построенный театр внутри, с игроками](/assets/server_history/season5/teatr_inside.webp){ decoding="async" loading="lazy" }
...
![Пранкеры в игре](/assets/server_history/season5/pranksters_real.webp){ decoding="async" loading="lazy" }

![Арт пранкеров](/assets/server_history/season5/pranksters_art.webp){ decoding="async" loading="lazy" }
...
![Неудачный эксперимент](/assets/server_history/season5/experiment.webp){ decoding="async" loading="lazy" }
...
![Всадник апокалипсиса](/assets/server_history/season5/skoroh.webp){ decoding="async" loading="lazy" }
...
![Портал в следующий сезон](/assets/server_history/season5/monuments.webp){ decoding="async" loading="lazy" }
