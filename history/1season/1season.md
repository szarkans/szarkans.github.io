...
Настолько познакомились, что на правах админа, Серёжа выдал ему редактора в группе КНКД, и они начали вместе постить кошкомальчиков.
...
![first_post](/assets/server_history/season1/first_post.webp)
...
- Зашёл клан MP, состоящий наполовину из читеров, а наполовину из долбаебов. Кто к какой касте пренадлежит - остаётся загадкой... Именно этот клан сжёг свою базу с свастонами.
