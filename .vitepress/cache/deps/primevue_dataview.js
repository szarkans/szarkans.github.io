      ...
      if (this.filterValue) {
        ...
        if (this.optionGroupLabel) {
          ...
          optionGroups.forEach(function(group) {
            ...
            if (filteredItems.length > 0) filtered.push(_objectSpread2(_objectSpread2({}, group), {}, _defineProperty3({}, typeof _this17.optionGroupChildren === "string" ? _this17.optionGroupChildren : "items", _toConsumableArray(filteredItems))));
          });
...
var script25 = {
  ...
  methods: {
    ...
    sort: function sort$1() {
      var _this = this;
      if (this.value) {
        var value = _toConsumableArray3(this.value);
