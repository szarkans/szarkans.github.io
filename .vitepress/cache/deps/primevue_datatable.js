...
var _hoisted_12 = ["data-p-checked", "data-p-disabled"];
...
function render6(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    "class": _ctx.cx("icon")
  }, $options.getPTOptions("icon")), null, 16)], 16)], 16, _hoisted_12);
}
...
var _hoisted_23 = ["onClick", "onKeydown", "tabindex"];
        ...
        "default": withCtx(function() {
          return [$data.overlayVisible ? withDirectives((openBlock(), createElementBlock("div", mergeProps({
            ...
            return openBlock(), createElementBlock("li", mergeProps({
              ...
              tabindex: i === 0 ? "0" : null,
              ref_for: true
            }, $options.getColumnPT("filterConstraint", $options.ptmFilterConstraintOptions(matchMode))), toDisplayString(matchMode.label), 17, _hoisted_23);
...
var script$2 = {
  ...
  computed: {
    ...
    sortableColumnIcon: function sortableColumnIcon() {
      ...
      if (!sorted2) return script26;
      else if (sorted2 && sortOrder2 > 0) return script28;
      else if (sorted2 && sortOrder2 < 0) return script27;
      return null;
    },
...
var _hoisted_13 = ["tabindex", "colspan", "rowspan", "aria-sort", "data-p-sortable-column", "data-p-resizable-column", "data-p-sorted", "data-p-filter-column", "data-p-frozen-column", "data-p-reorderable-column"];
...
var script29 = {
  ...
  methods: {
    ...
    sortSingle: function sortSingle(value) {
      ...
      var data11 = _toConsumableArray2(value);
    ...
    exportCSV: function exportCSV$1(options, data11) {
      ...
      if (!data11) {
        ...
        else if (this.frozenValue) data11 = data11 ? [].concat(_toConsumableArray2(this.frozenValue), _toConsumableArray2(data11)) : this.frozenValue;
      }
    ...
    onEditingMetaChange: function onEditingMetaChange2(event2) {
      var data11 = event2.data, field2 = event2.field, index = event2.index, editing2 = event2.editing;
