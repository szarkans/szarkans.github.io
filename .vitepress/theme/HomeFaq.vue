  ...
  <div class="faq-container">
    ...
    <div class="faq-right">
      <div class="discord-box">
        <a href="https://discord.gg/anVPzeKb" target="_blank" style="color: inherit; text-decoration: none;">
...
const faqItems = [
  ...
  },
  {
    ...
    content: 'Нужно написать заявку в нашем Дискорде! Кнопка на него справа (или сверху, если ты с телефона)'
  },
  {
